...
class CalculationDetails {
    ...
    CalculationDetails(Currency currency, BigDecimal agreedFx, int units, BigDecimal pricePerUnit) {
    ...
    private static BigDecimal calculateAmount(CalculationDetails ins) {
